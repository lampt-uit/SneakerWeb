...
function Register() {
	...
	return (
		<>
			<Toast type='err' msg='Ban thu lai lan sau nhe' />
					...
					<div className='row app-content'>
						<div className='col l-6 m-12 c-12'>
							<form action='' className='form' onSubmit={formik.handleSubmit}>
								...
								{showSuccessMsg('Dang ki thanh cong')}
								...
								<div className='content'>
									<ul>
										<li>
											...
											<span>
												Một lần đăng nhập chung duy nhất để tương tác với các
												sản phẩm và dịch vụ của của hàng
											</span>
										</li>
										<li>
											<i className='fal fa-check'></i>
