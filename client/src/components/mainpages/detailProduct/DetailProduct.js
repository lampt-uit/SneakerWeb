...
function DetailProduct() {
	...
	const toggleActive = (index) => {
		setIsButtonVisible({
			...isButtonVisible,
			activeObject: isButtonVisible.objects[index]
		});
	};
								...
								<div className='row sm-gutter'>
									...
									<div className='col l-6'>
										<div className='text-content'>
											...
											<p className='text'>
												Nâng tầm cuộc chơi của riêng bạn. Phiên bản này có sử
												dụng chất liệu tái chế, là một phần cam kết của adidas
												hướng tới chấm dứt rác thải nhựa.Sản phẩm này may bằng
												vải công nghệ Primeblue, chất liệu tái chế hiệu năng cao
												có sử dụng sợi Parley Ocean Plastic. 50% thân giày làm
												bằng vải dệt, 92% vải dệt bằng sợi Primeblue. Không sử
												dụng polyester nguyên sinh.
											</p>
										</div>
									</div>
									<div className='col l-6'>
